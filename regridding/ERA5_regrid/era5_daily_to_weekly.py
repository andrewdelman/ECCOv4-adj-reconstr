# create weekly mean ERA5 files (spanning a year)
# from daily mean ERA5 files (spanning a year)
...
# sys.path.append(join(expanduser('~'),'Documents','ERA5'))
...
#                                  weekly_bin_centers < np.datetime64(str(end_year)+'-08-02','ns')).nonzero()[0]
...
ds_src = xr.open_mfdataset(source_filepathform+str(start_year)+'_01.nc')
